...
from facefusion.uis.components import examples
...
def run(ui : gradio.Blocks) -> None:
	...
	ui.queue(default_concurrency_limit = concurrency_count).launch(show_api = False, quiet = True, inbrowser = facefusion.globals.open_browser)
